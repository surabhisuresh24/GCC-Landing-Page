...
const items: FAQItem[] = [
  { q: "What is CMA USA?", a: "CMA USA (Certified Management Accountant) is a globally recognized professional certification offered by the Institute of Management Accountants (IMA), USA. It is designed for finance and accounting professionals who work in management accounting or financial management." },
  { q: "How many parts are there in CMA USA exam?", a: "The CMA USA exam has two parts: Part 1 (Financial Planning, Performance, and Analytics) and Part 2 (Strategic Financial Management)." },
  { q: "What is the exam pattern for CMA USA?", a: "Each part consists of 100 multiple-choice questions and 2 essay scenarios. Total testing time is 4 hours per part (3 hours MCQs + 1 hour essays)." },
  { q: "What is the validity of CMA USA certification?", a: "Once certified and as long as you maintain IMA membership and meet CPE (Continuing Professional Education) requirements, the certification remains valid." },
  { q: "What are the career opportunities after CMA USA?", a: "Typical roles include Financial Analyst, Cost Accountant, Management Accountant, FP&A Analyst, Finance Manager, and Controller across industries and Big 4 firms." },
  { q: "What is the average salary after CMA USA in India?", a: "Compensation varies by experience and city; many CMA professionals see significant uplift. Figures often cited are competitive with mid-to-senior finance roles." },
  { q: "How is CMA USA different from other finance certifications?", a: "CMA emphasizes management accounting, analytics, and strategic decision-making inside organizations, complementing public-accounting or investment-focused credentials." },
];
    ...
    <section className="py-16 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">Get answers to common questions about CMA USA and our program</p>
        </div>
