      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-6">
            Master both parts of CMA USA with our structured 9-12 month program designed for working professionals globally          </p>
        ...
        >
          <h3 className="text-center text-2xl md:text-3xl font-extrabold text-gray-900 mb-6 md:mb-7">
            Your 9-12 Month Learning Journey
          </h3>
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-6">
            ...
            <div className="text-center px-2">
              ...
              <h4 className="font-semibold text-gray-900 text-base md:text-lg mb-1.5">
                Mastery (Months 10-12)
              </h4>
              <p className="text-gray-600 text-sm max-w-xs mx-auto">
                Intensive practice, mock exams, and global career support
              </p>
            </div>
          </div>
        </div>
